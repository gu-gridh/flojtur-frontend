    ...
    <article class="articleContainer">
      ...
      <div class="articleIngress">
        ...
        <blockquote>
          ...
          såsom Fleute-traversierer.”<sup>1</sup>
        </blockquote>
        <p>
          Denna korta beskrivning från slutet av 1700-talet är hämtad från Pehr
          Thams (1737–1820) reseskildring ”ifrån Westergöthland til Stockholm,
      ...
      <div class="articletext">
        ...
        <p>
          ...
          ett båtsmanstorp som tillhandahölls av ett antal gårdar i
          hemförsamlingen. Pehr växte alltså upp under ganska enkla förhållanden
          i båtsmanstorpet, och flyttade som ung till Stockholm för att bli
          bildhuggare. Från 1777 gick han i lära hos en av de främsta
          bildhuggarna i Stockholm, Johan Ljung (1717–1787). Johan Ljung
          arbetade bland annat med utsmyckningen av Kungliga slottet i
        ...
        <p>
          ...
          flera strängar på sin lyra. Han är idag kanske främst känd som orgel-
          och spelursbyggare. Väl känt är att han 1791 ansökte om privilegium
          att få tillverka spelur med valsar.<sup>7</sup> I ansökan intygas att
          han har nödvändiga kunskaper för detta, men tyvärr saknas
          originalhandlingar utvisande var han lärt sig detta hantverk. En
          rimlig förklaring är att han lärde sig det finmekaniska hantverket hos
          någon etablerad urmakare i Stockholm. Något som tyder på det är att
          det i privilegiebeslutet konstateras att Strand lovar att inte själv
          tillverka urverken till speluren utan vända sig till någon etablerad
          mästare. Det kan ha varit en medveten taktik för att förekomma kritik
          från urmakarmästare om att han inkräktade på deras område. Vissa av
          speluren är dock på urtavlan signerade Pehr eller Petter Strand.
          Eventuellt kan detta betyda att de i sin helhet är tillverkade senare,
          när Strand etablerat sig och när urmakarämbetet försvagats, vilket
          skedde mot slutet av 1700-talet.<sup>8</sup> Ett belägg för att Strand
          kunde bygga urverk är en signerad väggpendyl, en gåva till dottern
        ...
        <p>
          ...
          lacktillverkning.<sup>9</sup> Lacktillverkningen verkar inte ha krävt
          tillstånd, varför någon privilegieansökan från Strand inte finns för
          den verksamheten. Om det är fråga om lack för sigill eller för målning
          klargörs inte, men möjligen gäller det sigillack. Sådan tillverkning
          finns beskriven, medan lack för målning troligen tillverkades av
          hantverkaren själv efter behov.<sup>10</sup> Hur korkskäreriet
          samverkar med övriga verksamheter är oklart men tillsammans med
          sigillacktillverkning verkar de ha utgjort sidoinkomster då dessa
          hantverk inte behövs för spelurstillverkning. Utöver
          spelurstillverkningen är Strand i Sverige bäst känd som orgelbyggare.
          Den ljudalstrande delen i ett spelur med pipor, ett flöjtur, är i
          praktiken en liten orgel, så hantverket är i stor utsträckning
          detsamma. Redan 1789 anges han som byggare av orgeln i Tysslinge kyrka
          strax väster om Örebro.<sup>11</sup> Var han lärde sig
          orgelbyggarhantverket är inte heller känt, men stilistiskt ansluter
          han till det som kallas Stockholmsskolan inom det svenska
          ...
          orgeln av Pehr Strand finns i Sundal-Ryrs gamla kyrka i Dalsland. Det
          är en liten kammarorgel med tre stämmor, byggd 1795 och signerad inne
          i väderlådan, på vilken alla pipor står uppställda. Allt som allt
          byggde Strand ett trettiotal orglar. Det var förmodligen särskilt
          hedersamt för honom att han fick uppdraget att bygga en ny orgel åt
        ...
        <p>
          ...
          Urfabriker och Musikaliska instrumentmakare, och antal arbetare var 7
          respektive 8, totalt 15 personer.<sup>13</sup> Strands första
      ...
      <div class="articletext footnotes">
        ...
        <p>
          ...
          jemte Lacktillverkningen, äfwen få drifwa Korkskäreri.” SSA, Hall- och
          manufakturrätten, Previlegieböcker [sic!], E 3:4 (1757–1767), s. 254.
        </p>
        <p>
        ...
        <p>
          ...
          kyrkoarkiv, Sockenstämmoprotokoll, K I a:1 (1806–1841), bilderna 6ff.
        </p>
        <p>
